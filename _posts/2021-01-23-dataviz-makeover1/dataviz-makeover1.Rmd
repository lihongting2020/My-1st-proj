...
Data Visualisation (Tableau Online): [Singapore Resident Labour Force, 2009 vs 2019](https://public.tableau.com/views/DataViz1-SingaporeLabourForce2009vs2019/ResidentLabourForceDashboard?:language=en&:display_count=y&:toolbar=n&:origin=viz_share_link)
...
```{r proposal, echo=FALSE, fig.cap="Sketch of propose", out.width = '400', out.height='600'}
...
First, inspect data in excel, Table 7 includes resident labour force by 12 age sub-groups. Sheets, T7_F and T7_M are processed with following steps: (1) to remove excess rows at left and columns at right; (2) to add a new column 'gender' by tab name.
...
Repeat import and pivot likewise for the calculated table, "Resident population" sheet and join by "Year" with "T7_breakdown". After pivoting 11 years, comprehend join selection for resident labour force, and working-aged resident sheets by Gender and Age sub group. 
...
From the dot chart, we can observe that LFPR increase across 3 age groups, with 55 years old and over being the most substantial one. 
