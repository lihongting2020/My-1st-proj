...
Data Visualisation (Tableau Online): [To vaccine or not vaccine: what is public view?](https://public.tableau.com/profile/lihongting#!/vizhome/Tovaccineornotvaccinewhatispublicview/Main)
...
a. Element 1: an "Image" object
b. Element 2, 3, 7, 8, 11: "Text" object
c. Element 4, 5, 6; "sheet" for navigation 
d. Element 9: a donut chart
e. Element 10: circle chart with confidence interval plus 2 filters
...
knitr::include_graphics("3.2.1overview.png")

```

#### 3.3.1 Creating a donut chart
...
#### 3.3.2 Creating a circle chart with confidence interval for proportion
...
```{r 332CI1, echo=FALSE, fig.cap="Creating a parameter for confidence level 1", out.width = '200'}
...
```{r 332CI2, echo=FALSE, fig.cap="Creating a parameter for confidence level 2",out.width = '600'}
knitr::include_graphics("3.2.2CI2_1.png")
...
> qnorm:
> IF [confidence level for CI]=0.99 THEN 2.3263
ELSEIF [confidence level for CI]=0.98 THEN 2.0537
ELSEIF [confidence level for CI] = 0.95 THEN 1.6449
elseif [confidence level for CI]= 0.9 THEN 1.2816
END
...
knitr::include_graphics("3.2.2CI15_1.png")
...
#### 3.3.3 Interaction within a dashboard
...
```{r 333db1, echo=FALSE, fig.cap="Adding action for interaction within in dashboard 1", out.width = '400'}
...
```{r 351ht1, echo=FALSE, fig.cap="Select chart type from Show Me", out.width = '400'}
...
knitr::include_graphics("4.1insight1_1.png")
```
...
knitr::include_graphics("4.1insight2_1.png")
```
